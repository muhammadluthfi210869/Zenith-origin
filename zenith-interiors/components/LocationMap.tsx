                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="lg:col-span-1 space-y-8">
                        <div>
                            ...
                            <h3 className="text-4xl font-serif mb-6">Jangkauan Layanan</h3>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-start gap-4 p-4 bg-white/5 rounded-xl border border-white/10">
                                ...
                                <div>
                                    <h4 className="font-bold text-lg">Zenith Studio</h4>
                                    <p className="text-neutral-400 text-sm mb-2">Jl. Setiabudi No. 123, Bandung</p>
                                    <a
                                        href="https://maps.app.goo.gl/4E7G2qqi2Bf9Pix16"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="text-luxury-gold text-sm hover:underline flex items-center gap-1"
                                    >
                                        Buka di Google Maps <Navigation size={12} />
                                    </a>
                                </div>
                            </div>
                        </div>
